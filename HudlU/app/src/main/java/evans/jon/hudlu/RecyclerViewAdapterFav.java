...
public class RecyclerViewAdapterFav extends RecyclerView.Adapter<RecyclerViewAdapterFav.MyViewHolder>{
    ...
    public RecyclerViewAdapterFav(Context ctx, List<MashableNewsItem> myDataset) {
        mDataSet = myDataset;
